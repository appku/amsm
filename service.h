...
#define AMSM_KERNEL_DRIVER _T("SERVICE_KERNEL_DRIVER")
#define AMSM_FILE_SYSTEM_DRIVER _T("SERVICE_FILE_SYSTEM_DRIVER")
#define AMSM_WIN32_OWN_PROCESS _T("SERVICE_WIN32_OWN_PROCESS")
#define AMSM_WIN32_SHARE_PROCESS _T("SERVICE_WIN32_SHARE_PROCESS")
#define AMSM_INTERACTIVE_PROCESS _T("SERVICE_INTERACTIVE_PROCESS")
#define AMSM_SHARE_INTERACTIVE_PROCESS AMSM_WIN32_SHARE_PROCESS _T("|") AMSM_INTERACTIVE_PROCESS
#define AMSM_UNKNOWN _T("?")

#define AMSM_ROTATE_OFFLINE 0
#define AMSM_ROTATE_ONLINE 1
#define AMSM_ROTATE_ONLINE_ASAP 2
