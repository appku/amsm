...
@echo>version.h.new #define AMSM_VERSION _T("%description%")
@echo>>version.h.new #define AMSM_VERSIONINFO %major%,%minor%,%n%,%BUILD_NUMBER%
@echo>>version.h.new #define AMSM_DATE _T("%DATE%")
@echo>>version.h.new #define AMSM_FILEFLAGS %flags%
@echo>>version.h.new #define AMSM_COPYRIGHT _T("AppKu™, Append Media, LLC. Fork of NSSM (Iain Patterson)")
