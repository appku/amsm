...
#define AMSM_LOCALSYSTEM_ACCOUNT _T("LocalSystem")
/* Other well-known accounts which can start a service without a password. */
#define AMSM_LOCALSERVICE_ACCOUNT _T("NT Authority\\LocalService")
#define AMSM_NETWORKSERVICE_ACCOUNT _T("NT Authority\\NetworkService")
/* Virtual service accounts. */
#define AMSM_VIRTUAL_SERVICE_ACCOUNT_DOMAIN _T("NT Service")
/* This is explicitly a wide string. */
#define AMSM_LOGON_AS_SERVICE_RIGHT L"SeServiceLogonRight"
