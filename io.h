...
#define AMSM_STDIN_SHARING FILE_SHARE_WRITE
#define AMSM_STDIN_DISPOSITION OPEN_EXISTING
#define AMSM_STDIN_FLAGS FILE_ATTRIBUTE_NORMAL
#define AMSM_STDOUT_SHARING (FILE_SHARE_READ | FILE_SHARE_WRITE)
#define AMSM_STDOUT_DISPOSITION OPEN_ALWAYS
#define AMSM_STDOUT_FLAGS FILE_ATTRIBUTE_NORMAL
#define AMSM_STDERR_SHARING (FILE_SHARE_READ | FILE_SHARE_WRITE)
#define AMSM_STDERR_DISPOSITION OPEN_ALWAYS
#define AMSM_STDERR_FLAGS FILE_ATTRIBUTE_NORMAL
